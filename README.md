...
A professional-grade baseball/softball scorekeeping application built with React Native and Expo. This app provides a "Purist" scoring experience with a fixed lineup column and a scrollable 9-inning grid.
